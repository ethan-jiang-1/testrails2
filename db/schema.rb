...
ActiveRecord::Schema.define(:version => 20131022142753) do
  ...
  create_table "offer_versions", :force => true do |t|
  ...
  add_index "offer_versions", ["item_type", "item_id"], :name => "index_offer_versions_on_item_type_and_item_id"
